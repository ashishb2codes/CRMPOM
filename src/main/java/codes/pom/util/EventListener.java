...
public class EventListener extends BaseMain implements WebDriverEventListener{
	
	// This is the class for tracking actions
	
	@Override
	public void beforeNavigateTo(String url, WebDriver driver) {
		System.out.println("Before navigationg to : " +url);
	}
	...
	public void beforeChangeValueOf(WebElement element, WebDriver driver, CharSequence[] arg2) {
		System.out.println("Before chaning the value of element is : " +element.toString());
	}
	
	@Override
	public void afterChangeValueOf(WebElement element, WebDriver driver, CharSequence[] arg2) {
		System.out.println("After chaning the value of element is : " +element.toString());
	...
	public void afterFindBy(By by, WebElement element, WebDriver driver) {
		System.out.println("Found the element by : " + by.toString());
	}
	...
	// Below methods are not overridden
	@Override
