package codes.pom.ExtentReport;
...
public class ProjectExtentReport implements IReporter{
	ExtentReports extentReports;

	@Override
	public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> iSuites, String outputDirectory) {
		extentReports = new ExtentReports(outputDirectory + File.separator + "ProjectExtentReport.html", true);
